...
/**                                                                       **/
/**  Debug.h    Debug support routines for the Windows 98 Parallel Port   **/
/**             support routines driver                                   **/
/**                                                                       **/
/**                                                                       **/
/**                                                                       **/
...
extern ULONG W98Ports_DebugLevel;

#define PPJOY_DBGPRINT(_debugMask_,_x_)							\
			if ( (_debugMask_)&W98Ports_DebugLevel )			\
			{													\
			 DbgPrint(W98_DRIVER_FILENAME ": ");			\
...
#define ExAllocPool(Type,Size)		ExAllocatePoolWithTag (Type,Size,W98PORTS_POOL_TAG)

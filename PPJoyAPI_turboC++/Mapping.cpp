...
SAxisDefines	AxisUsageList[]=
	{
	{HID_USAGE_PAGE_GENERIC,HID_USAGE_GENERIC_X,"X Axis"},
	{HID_USAGE_PAGE_GENERIC,HID_USAGE_GENERIC_Y,"Y Axis"},
	{HID_USAGE_PAGE_GENERIC,HID_USAGE_GENERIC_Z,"Z Axis"},
	{HID_USAGE_PAGE_GENERIC,HID_USAGE_GENERIC_RX,"X Rotation"},
	{HID_USAGE_PAGE_GENERIC,HID_USAGE_GENERIC_RY,"Y Rotation"},
	{HID_USAGE_PAGE_GENERIC,HID_USAGE_GENERIC_RZ,"Z Rotation"},
	{HID_USAGE_PAGE_GENERIC,HID_USAGE_GENERIC_SLIDER,"Slider"},
	{HID_USAGE_PAGE_GENERIC,HID_USAGE_GENERIC_DIAL,"Dial"},
	{HID_USAGE_PAGE_GENERIC,HID_USAGE_GENERIC_WHEEL,"Wheel"},
	{HID_USAGE_PAGE_GENERIC,HID_USAGE_GENERIC_VX,"VX Axis"},
	{HID_USAGE_PAGE_GENERIC,HID_USAGE_GENERIC_VY,"VY Axis"},
	{HID_USAGE_PAGE_GENERIC,HID_USAGE_GENERIC_VZ,"VZ Axis"},
	{HID_USAGE_PAGE_GENERIC,HID_USAGE_GENERIC_VBRX,"VBRX Axis"},
	{HID_USAGE_PAGE_GENERIC,HID_USAGE_GENERIC_VBRY,"VBRY Axis"},
	{HID_USAGE_PAGE_GENERIC,HID_USAGE_GENERIC_VBRZ,"VBRZ Axis"},
	{HID_USAGE_PAGE_SIMULATION,HID_USAGE_SIMULATION_RUDDER,"Rudder"},
	{HID_USAGE_PAGE_SIMULATION,HID_USAGE_SIMULATION_THROTTLE,"Throttle"},
	{0,0,NULL}
	};
//
...
HANDLE OpenJoystickDevice (int Port, int SubAddr)
{
 ...
 sprintf (DeviceName,"\\\\.\\PPJoyCtl%d:%d",Port,SubAddr+1);
